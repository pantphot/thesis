...
class TalkerQos(Node):
    ...
    def __init__(self, qos_profile):
        ...
        self.pub = self.create_publisher(Header, 'chatter', qos_profile=qos_profile)
    ...
    def timer_callback(self):
        ...
        self.msg.header.frame_id = '{0}'.format(self.i)
        self.i += 1
        self.get_logger().info('Publishing: "{0}"'.format(self.msg.header.frame_id))
