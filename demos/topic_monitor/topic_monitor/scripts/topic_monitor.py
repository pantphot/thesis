        ...
        for topic_name, type_names in topic_names_and_types:
            ...
            if is_new_topic:
                ...
                topic_monitor.add_monitored_topic(
                    options.msg_type, topic_name, node, qos_profile,
...
def main():
    ...
    args.msg_type = getattr(sensor_msgs.msg,args.msg_type)
