...
int main(int argc, char * argv[])
{
  ...
  // Load the cascades
  auto face_cascade_name = "./src/face_detection/data/haarcascade_frontalface_alt.xml";
  ...
  while (rclcpp::ok()) {
    ...
    if (!frame.empty()) {
      ...
      if (show_camera) {
        ...
        CvMat cvframe = frame;
        // Show the image in a window called "face_detection".
        cvShowImage("face_detection", &cvframe);
